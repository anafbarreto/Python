"""Com uma herança, uma classe herda os metodos e atributos de outra classe.
A herança cria uma relação de "é" do mesmo tipo uqe outra:
Por exemplo, o estudante é uma pessoa.
Diferente da relação de "tem". Como, o estudante tem livros.
"""
...
class Estudante(Pessoa): # o nome da classe base vem em parênteses
    def __init__(self, name, curso):
        super().__init__(name) # o super chama o construtor da classe base
        self._curso = curso
