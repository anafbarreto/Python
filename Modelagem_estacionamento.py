from Estacionamento_poo import * # o import com * nesse caso é pq vamos precisar de tudo mesmo
from random import randint # Gerar numeros aleatorios pras placas de carro e moto
